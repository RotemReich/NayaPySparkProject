...
car_models_df.coalesce(1).write.mode("overwrite").csv("s3a://spark/data/dims/car_models.csv", header=True)
...
car_colors_df.coalesce(1).write.mode("overwrite").csv("s3a://spark/data/dims/car_colors.csv", header=True)
